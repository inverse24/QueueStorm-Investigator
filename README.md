...
```json
{
  ...
  "complaint": "I sent 500 BDT to Ahmed but he never got it",
  "language": "en",
  "channel": "app",
  "user_type": "customer",
  "transaction_history": [
...
```json
{
  ...
  "severity": "high",
  "department": "transaction_operations",
  "agent_summary": "Customer reports 500 BDT transfer to Ahmed marked pending. Transaction confirms amount and timing match complaint. Investigate delivery with receiving bank.",
  "recommended_next_action": "Contact recipient bank to verify delivery. If undelivered, initiate reversal within 24 hours.",
  "customer_reply": "Thank you for reporting this issue. We've identified the transaction and are investigating with the recipient's bank. You'll receive an update within 24 hours.",
  "human_review_required": true,
  "confidence": 0.85,
  "reason_codes": ["PENDING_TRANSFER", "AMOUNT_MATCH"]
}
```
